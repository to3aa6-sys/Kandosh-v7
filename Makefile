...
KandoshV7_FILES = ImGuiDrawView.mm $(wildcard *.mm) $(wildcard Security/*.mm) $(wildcard hook/*.cpp) $(wildcard hook/*.mm) $(wildcard imgui/*.cpp) $(wildcard imgui/*.mm) $(wildcard drawEsp/*.mm)
